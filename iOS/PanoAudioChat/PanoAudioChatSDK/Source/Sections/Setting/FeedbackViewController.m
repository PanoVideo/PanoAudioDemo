...
//  PanoCall
//
//  Created by Sand Pei on 2020/4/8.
//  Copyright © 2020 Pano. All rights reserved.
//

#import "FeedbackViewController.h"
#import <PanoRtc/PanoRtc.h>
...
- (IBAction)clickSend:(id)sender {
    [PanoClientService.service sendFeedback:[self feedbackType] detail:self.problemDescription.text uploadLogs:self.uploadLog.on contact:self.contact.text];
    [self dismissViewControllerAnimated:YES completion:nil];
...
- (void)keyboardWillShow:(NSNotification*)notification {
    ...
    float textY = textFrame.origin.y + textFrame.size.height + 80;
