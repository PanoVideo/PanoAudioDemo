...
- (IBAction)clickSend:(id)sender {
    [[PanoClientService service] sendFeedbackWithType:[self feedbackType] detail:self.problemDescription.text uploadLogs:self.uploadLog.on contact:self.contact.text];
